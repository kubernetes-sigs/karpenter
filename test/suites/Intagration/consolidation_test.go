...
// 										Operator: corev1.NodeSelectorOpIn,
// 										Values:   lo.Ternary(spotToSpot, []string{v1.CapacityTypeSpot}, []string{v1.CapacityTypeOnDemand}),
// 									},
// 								},
// 								{
// 									NodeSelectorRequirement: corev1.NodeSelectorRequirement{
...
// 					continue
// 				}
// 				if n.Labels[v1.CapacityTypeLabelKey] == v1.CapacityTypeSpot {
...
// 	// 		Expect(n.Labels).To(HaveKeyWithValue(v1.CapacityTypeLabelKey, v1.CapacityTypeOnDemand))
...
// 	// 				if val, ok := n.Labels[v1.NodePoolLabelKey]; !ok || val != nodePool.Name {
// 	// 					return false
// 	// 				}
// 	// 				return true
// 	// 			})
...
// 	// 			g.Expect(filtered[0].Labels).To(HaveKeyWithValue(v1.CapacityTypeLabelKey, v1.CapacityTypeReserved))
...
// 	// 		Expect(n.Labels).To(HaveKeyWithValue(v1.CapacityTypeLabelKey, v1.CapacityTypeReserved))
