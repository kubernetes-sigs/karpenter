...
require (
	...
	sigs.k8s.io/kube-api-linter v0.0.0-20251201121224-8e86c463aeb8 // indirect
...
// Tool dependency conflict resolution (does not affect main module builds)
replace google.golang.org/genproto => google.golang.org/genproto v0.0.0-20250603155806-513f23925822

replace github.com/google/ko => github.com/google/ko v0.15.4

replace github.com/google/go-containerregistry => github.com/google/go-containerregistry v0.19.2
...
// v1.32.3 has a checksum mismatch due to upstream re-publishing the release
replace github.com/envoyproxy/go-control-plane/envoy v1.32.3 => github.com/envoyproxy/go-control-plane/envoy v1.32.4
