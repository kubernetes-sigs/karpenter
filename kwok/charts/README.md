...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"nodePoolDriftBackoff":false,"nodeRepair":false,"spotToSpotConsolidation":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect","schedulerConfig":""}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"nodePoolDriftBackoff":false,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.nodePoolDriftBackoff | bool | `false` | nodePoolDriftBackoff is disabled by default. Setting this to true enables per-NodePool exponential back-off on unrecoverable drift replacement failures. |
