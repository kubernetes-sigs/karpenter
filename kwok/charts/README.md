...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"multiNodeMultiReplacement":false,"nodeRepair":false,"spotToSpotConsolidation":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect"}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"multiNodeMultiReplacement":false,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.multiNodeMultiReplacement | bool | `false` | multiNodeMultiReplacement is ALPHA and is disabled by default. Setting this to true allows bounded multi-node consolidation into exactly two replacement NodeClaims. |
