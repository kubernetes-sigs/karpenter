...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"nodeRepair":false,"spotToSpotConsolidation":false},"preferencePolicy":"Respect"}` | Global Settings to configure Karpenter |
