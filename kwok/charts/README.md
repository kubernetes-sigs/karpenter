...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"capacityBuffer":false,"nodeRepair":false,"spotToSpotConsolidation":false,"staticCapacity":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect"}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"capacityBuffer":false,"nodeRepair":false,"spotToSpotConsolidation":false,"staticCapacity":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.capacityBuffer | bool | `false` | capacityBuffer is ALPHA and is disabled by default. Setting this to true will enable capacity buffers. |
