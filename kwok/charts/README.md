...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"nodePoolDriftBackoff":true,"nodeRepair":false,"spotToSpotConsolidation":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect","schedulerConfig":""}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"nodePoolDriftBackoff":true,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.nodePoolDriftBackoff | bool | `true` | nodePoolDriftBackoff is enabled by default. Setting this to false disables per-NodePool exponential back-off on unrecoverable drift replacement failures. |
