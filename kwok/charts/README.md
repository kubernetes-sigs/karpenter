...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"nodeReadyTimeoutRecovery":false,"nodeRepair":false,"spotToSpotConsolidation":false},"preferencePolicy":"Respect"}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"nodeReadyTimeoutRecovery":false,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.nodeReadyTimeoutRecovery | bool | `false` | nodeReadyTimeoutRecovery is ALPHA and is disabled by default. Setting this to true will enable automatic recovery of nodes that fail to become ready within a timeout. |
