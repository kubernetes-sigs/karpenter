...
func (o *Options) AddFlags(fs *FlagSet) {
	...
	fs.BoolVarWithEnv(&o.DisableLeaderElection, "disable-leader-elect", "DISABLE_LEADER_ELECT", false, "Start leader election client and gain leadership before executing the main loop. Enable this when running replicated components for high availability.")
