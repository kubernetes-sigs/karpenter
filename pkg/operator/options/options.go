...
func (o *Options) AddFlags(fs *FlagSet) {
	...
	fs.BoolVarWithEnv(&o.DisableClusterStateObservability, "disable-cluster-state-observability", "DISABLE_CLUSTER_STATE_OBSERVABILITY", false, "Optionally disable cluster state metrics and events")
