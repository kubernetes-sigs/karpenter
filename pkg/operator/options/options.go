...
func (o *Options) AddFlags(fs *FlagSet) {
	...
	fs.StringVar(&o.LeaderElectionID, "leader-election-id", env.WithDefaultString("LEADER_ELECTION_ID", "karpenter-leader-election"), "Leader election ID to create and monitor the lease if running outside the cluster")
