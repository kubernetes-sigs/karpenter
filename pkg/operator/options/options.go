...
func (o *Options) AddFlags(fs *FlagSet) {
	...
	fs.Float64Var(&o.ConsolidationMinSavingsPerDisruptionCost, "consolidation-min-savings-per-disruption-cost", env.WithDefaultFloat64("CONSOLIDATION_MIN_SAVINGS_PER_DISRUPTION_COST", 0), "Minimum savings per unit of disruption cost required for consolidation. A value of 0 disables this check. Example: 0.01 means save at least $0.01/hr per unit of disruption cost.")
