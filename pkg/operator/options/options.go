...
func (o *Options) AddFlags(fs *FlagSet) {
	...
	fs.BoolVarWithEnv(&o.DisableLeaderElection, "disable-leader-elect", "DISABLE_LEADER_ELECT", false, "Disable the leader election client before executing the main loop. Disable when running replicated components for high availability is not desired.")
