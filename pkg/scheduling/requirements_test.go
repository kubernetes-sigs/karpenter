...
var _ = Describe("Requirements", func() {
	Context("Compatibility", func() {
		...
		It("should be strictly compatible", func() {
			...
			Expect(unconstrained.StrictlyCompatible(exists)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(unconstrained.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			// All expectation below are the same as the compatible
			Expect(unconstrained.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(unconstrained.StrictlyCompatible(doesNotExist)).To(Succeed())
			Expect(unconstrained.StrictlyCompatible(notInA)).To(Succeed())
			Expect(unconstrained.StrictlyCompatible(notIn12)).To(Succeed())

			Expect(exists.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(exists.StrictlyCompatible(exists)).To(Succeed())
			Expect(exists.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(exists.StrictlyCompatible(inA)).To(Succeed())
			Expect(exists.StrictlyCompatible(inB)).To(Succeed())
			Expect(exists.StrictlyCompatible(inAB)).To(Succeed())
			Expect(exists.StrictlyCompatible(notInA)).To(Succeed())
			Expect(exists.StrictlyCompatible(in1)).To(Succeed())
			Expect(exists.StrictlyCompatible(in9)).To(Succeed())
			Expect(exists.StrictlyCompatible(in19)).To(Succeed())
			Expect(exists.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(exists.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(exists.StrictlyCompatible(greaterThan9)).To(Succeed())
			Expect(exists.StrictlyCompatible(lessThan1)).To(Succeed())
			Expect(exists.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(doesNotExist.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(doesNotExist.StrictlyCompatible(exists)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(doesNotExist)).To(Succeed())
			Expect(doesNotExist.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(notInA)).To(Succeed())
			Expect(doesNotExist.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(doesNotExist.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(doesNotExist.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(inA.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(inA.StrictlyCompatible(exists)).To(Succeed())
			Expect(inA.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(inA)).To(Succeed())
			Expect(inA.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(inAB)).To(Succeed())
			Expect(inA.StrictlyCompatible(notInA)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(inA.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(inA.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(inB.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(inB.StrictlyCompatible(exists)).To(Succeed())
			Expect(inB.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(inB)).To(Succeed())
			Expect(inB.StrictlyCompatible(inAB)).To(Succeed())
			Expect(inB.StrictlyCompatible(notInA)).To(Succeed())
			Expect(inB.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(inB.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(inB.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(inAB.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(inAB.StrictlyCompatible(exists)).To(Succeed())
			Expect(inAB.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(inA)).To(Succeed())
			Expect(inAB.StrictlyCompatible(inB)).To(Succeed())
			Expect(inAB.StrictlyCompatible(inAB)).To(Succeed())
			Expect(inAB.StrictlyCompatible(notInA)).To(Succeed())
			Expect(inAB.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(inAB.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(inAB.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(notInA.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(notInA.StrictlyCompatible(exists)).To(Succeed())
			Expect(notInA.StrictlyCompatible(doesNotExist)).To(Succeed())
			Expect(notInA.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(notInA.StrictlyCompatible(inB)).To(Succeed())
			Expect(notInA.StrictlyCompatible(inAB)).To(Succeed())
			Expect(notInA.StrictlyCompatible(notInA)).To(Succeed())
			Expect(notInA.StrictlyCompatible(in1)).To(Succeed())
			Expect(notInA.StrictlyCompatible(in9)).To(Succeed())
			Expect(notInA.StrictlyCompatible(in19)).To(Succeed())
			Expect(notInA.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(notInA.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(notInA.StrictlyCompatible(greaterThan9)).To(Succeed())
			Expect(notInA.StrictlyCompatible(lessThan1)).To(Succeed())
			Expect(notInA.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(in1.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(in1.StrictlyCompatible(exists)).To(Succeed())
			Expect(in1.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(notInA)).To(Succeed())
			Expect(in1.StrictlyCompatible(in1)).To(Succeed())
			Expect(in1.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(in19)).To(Succeed())
			Expect(in1.StrictlyCompatible(notIn12)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(in1.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(in9.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(in9.StrictlyCompatible(exists)).To(Succeed())
			Expect(in9.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(notInA)).To(Succeed())
			Expect(in9.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(in9)).To(Succeed())
			Expect(in9.StrictlyCompatible(in19)).To(Succeed())
			Expect(in9.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(in9.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(in9.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(in9.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(in19.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(in19.StrictlyCompatible(exists)).To(Succeed())
			Expect(in19.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(notInA)).To(Succeed())
			Expect(in19.StrictlyCompatible(in1)).To(Succeed())
			Expect(in19.StrictlyCompatible(in9)).To(Succeed())
			Expect(in19.StrictlyCompatible(in19)).To(Succeed())
			Expect(in19.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(in19.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(in19.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(in19.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(notIn12.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(exists)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(doesNotExist)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(inA)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(inB)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(inAB)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(notInA)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(notIn12.StrictlyCompatible(in9)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(in19)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(greaterThan9)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(lessThan1)).To(Succeed())
			Expect(notIn12.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(greaterThan1.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(exists)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(notInA)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(in9)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(in19)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(greaterThan9)).To(Succeed())
			Expect(greaterThan1.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(greaterThan1.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(greaterThan9.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(exists)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(notInA)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(greaterThan9)).To(Succeed())
			Expect(greaterThan9.StrictlyCompatible(lessThan1)).ToNot(Succeed())
			Expect(greaterThan9.StrictlyCompatible(lessThan9)).ToNot(Succeed())

			Expect(lessThan1.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(lessThan1.StrictlyCompatible(exists)).To(Succeed())
			Expect(lessThan1.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(notInA)).To(Succeed())
			Expect(lessThan1.StrictlyCompatible(in1)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(in19)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(lessThan1.StrictlyCompatible(greaterThan1)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(lessThan1.StrictlyCompatible(lessThan1)).To(Succeed())
			Expect(lessThan1.StrictlyCompatible(lessThan9)).To(Succeed())

			Expect(lessThan9.StrictlyCompatible(unconstrained)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(exists)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(doesNotExist)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(inA)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(inB)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(inAB)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(notInA)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(in1)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(in9)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(in19)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(notIn12)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(greaterThan1)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(greaterThan9)).ToNot(Succeed())
			Expect(lessThan9.StrictlyCompatible(lessThan1)).To(Succeed())
			Expect(lessThan9.StrictlyCompatible(lessThan9)).To(Succeed())
		})
	})
