...
var _ = Describe("Provisioner Static Drift Hash", func() {
	...
	It("should update the static drift hash when provisioner static field is updated", func() {
		...
		Expect(provisioner.Annotations).To(HaveKeyWithValue(v1alpha5.ProvisionerHashAnnotationKey, expectedHash))
		...
		Expect(provisioner.Annotations).To(HaveKeyWithValue(v1alpha5.ProvisionerHashAnnotationKey, expectedHashTwo))
	})
