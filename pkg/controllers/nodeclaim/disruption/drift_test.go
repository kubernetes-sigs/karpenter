...
var _ = Describe("Drift", func() {
	...
	Context("NodePool Static Drift", func() {
		...
		DescribeTable("should detect drift on changes to the static fields",
			...
			Entry("NodeClassRef Group", v1.NodePool{Spec: v1.NodePoolSpec{Template: v1.NodeClaimTemplate{Spec: v1.NodeClaimSpec{NodeClassRef: &v1.NodeClassReference{Group: "testGroup"}}}}}),
