...
func (n *NodeClaim) CanSchedule(ctx context.Context, pod *corev1.Pod, podData *PodData) (scheduling.Requirements, []*cloudprovider.InstanceType, []*cloudprovider.Offering, error) {
	// Check Taints
