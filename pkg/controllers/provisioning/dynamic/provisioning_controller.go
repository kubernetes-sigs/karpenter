...
func NewProvisioningController(kubeClient client.Client, recorder events.Recorder,
	cloudProvider cloudprovider.CloudProvider, cluster *state.Cluster,
	clock clock.Clock,
) *ProvisioningController {
	p := &ProvisioningController{
...
func (p *ProvisioningController) Trigger(uid types.UID) {
	p.batcher.Trigger(uid)
}

func (p *ProvisioningController) Register(_ context.Context, m manager.Manager) error {
...
func (p *ProvisioningController) Reconcile(ctx context.Context) (result reconcile.Result, err error) {
	...
	if _, err = p.provisioner.CreateNodeClaims(ctx, results.NewNodeClaims, provisioning.WithReason(metrics.ProvisionedReason), provisioning.RecordPodNomination); err != nil {
		return reconcile.Result{}, err
	}
	return reconcile.Result{RequeueAfter: singleton.RequeueImmediately}, nil
}

func (p *ProvisioningController) GetPendingPods(ctx context.Context) ([]*corev1.Pod, error) {
...
// nolint:gocyclo
func (p *ProvisioningController) consolidationWarnings(ctx context.Context, pods []*corev1.Pod) {
...
//nolint:gocyclo
func (p *ProvisioningController) NewScheduler(
	ctx context.Context,
	pods []*corev1.Pod,
...
func (p *ProvisioningController) Schedule(ctx context.Context) (scheduler.Results, error) {
...
func (p *ProvisioningController) getDaemonSetPods(ctx context.Context) ([]*corev1.Pod, error) {
...
func (p *ProvisioningController) Validate(ctx context.Context, pod *corev1.Pod) error {
...
func (p *ProvisioningController) injectVolumeTopologyRequirements(ctx context.Context, pods []*corev1.Pod) ([]*corev1.Pod, error) {
