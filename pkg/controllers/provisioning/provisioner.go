...
func (p *Provisioner) Schedule(ctx context.Context) (scheduler.Results, error) {
	...
	s, err := p.NewScheduler(
		...
		pods,
		nodes.Active(),
		append([]scheduler.Options{scheduler.DisableReservedCapacityFallback}, lo.Ternary(options.FromContext(ctx).PreferencePolicy == options.PreferencePolicyIgnore, scheduler.IgnorePreferences, nil))...,
	)
	if err != nil {
