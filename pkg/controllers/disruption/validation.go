...
func (v *validation) validateCommand(ctx context.Context, cmd Command, candidates []*Candidate) error {
	...
	results, err := SimulateScheduling(ctx, v.kubeClient, v.cluster, v.provisioner, v.clock, v.recorder,
		[]scheduling.Options{scheduling.IsConsolidationSimulation}, SimulationOptions{}, candidates...)
	if err != nil {
