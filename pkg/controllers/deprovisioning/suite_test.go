...
var _ = Describe("Replace Nodes", func() {
	...
	It("can replace nodes, considers do-not-consolidate annotation", func() {
		...
		// inform cluster state about nodes and machines
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{regularNode, annotatedNode}, []*v1alpha5.Machine{regularMachine, annotatedMachine})
...
var _ = Describe("Delete Node", func() {
	...
	It("can delete nodes, when non-Karpenter capacity can fit pods", func() {
		...
		// inform cluster state about nodes and machines
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{node1, unmanagedNode}, []*v1alpha5.Machine{machine1})
	...
	It("won't delete node if it would require pods to schedule on an un-initialized node", func() {
		...
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{node2}, []*v1alpha5.Machine{machine2})
	...
	It("should consider initialized nodes before un-initialized nodes", func() {
		...
		for i := 0; i < podCount; i++ {
			...
			if i == elem {
				ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{n}, []*v1alpha5.Machine{m})
			} else {
		...
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{consolidatableNode}, []*v1alpha5.Machine{consolidatableMachine})
...
var _ = Describe("Topology Consideration", func() {
	...
	It("can replace node maintaining zonal topology spread", func() {
		...
		// inform cluster state about nodes and machines
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{zone1Node, zone2Node, zone3Node}, []*v1alpha5.Machine{zone1Machine, zone2Machine, zone3Machine})
...
var _ = Describe("Consolidation Timeout", func() {
	...
	It("should return the last valid command when multi-machine consolidation times out", func() {
		...
		// inform cluster state about nodes and machines
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, nodes, machines)
...
var _ = Describe("Parallelization", func() {
	...
	It("should not consolidate a node that is launched for pods on a deleting node", func() {
		...
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, nodes, nil)
...
var _ = Describe("Multi-Node Consolidation", func() {
	...
	It("can merge 3 nodes into 1", func() {
		...
		// inform cluster state about nodes and machines
		ExpectMakeNodesMachinesInitializedAndStateUpdated(ctx, env.Client, nodeStateController, machineStateController, []*v1.Node{node1, node2, node3}, []*v1alpha5.Machine{machine1, machine2, machine3})
