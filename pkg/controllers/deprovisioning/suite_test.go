...
var _ = BeforeSuite(func() {
	...
	terminator := terminator.NewTerminator(fakeClock, env.Client, terminator.NewEvictionQueue(ctx, env.KubernetesInterface.CoreV1(), events.NewRecorder(&record.FakeRecorder{})))
