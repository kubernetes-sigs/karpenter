...
func (c *Cluster) MarkPodSchedulingDecisions(ctx context.Context, podErrors map[*corev1.Pod]error, podsNewNodeClaims map[string][]*corev1.Pod) {
	now := c.clock.Now()
	...
	for nodePoolName, pods := range podsNewNodeClaims {
