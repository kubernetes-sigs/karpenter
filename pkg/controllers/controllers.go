...
func NewControllers(
	...
	return []controller.Controller{
		...
		termination.NewController(kubeClient, termination.NewTerminator(clock, kubeClient, cloudProvider, termination.NewEvictionQueue(ctx, kubernetesInterface.CoreV1(), recorder)), recorder),
