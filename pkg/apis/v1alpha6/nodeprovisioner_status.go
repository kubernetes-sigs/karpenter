...
type NodeProvisionerStatus struct {
...
func (p *NodeProvisioner) StatusConditions() apis.ConditionManager {
	return apis.NewLivingConditionSet().Manage(p)
}

func (p *NodeProvisioner) GetConditions() apis.Conditions {
	return p.Status.Conditions
}

func (p *NodeProvisioner) SetConditions(conditions apis.Conditions) {
