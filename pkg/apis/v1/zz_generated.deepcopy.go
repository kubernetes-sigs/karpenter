...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePoolRepairPolicy) DeepCopyInto(out *NodePoolRepairPolicy) {
	*out = *in
	out.TolerationDuration = in.TolerationDuration
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePoolRepairPolicy.
func (in *NodePoolRepairPolicy) DeepCopy() *NodePoolRepairPolicy {
	if in == nil {
		return nil
	}
	out := new(NodePoolRepairPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RepairSpec) DeepCopyInto(out *RepairSpec) {
	*out = *in
	if in.Policies != nil {
		...
		*out = make([]NodePoolRepairPolicy, len(*in))
		copy(*out, *in)
	}
	if in.DefaultTolerationDuration != nil {
		in, out := &in.DefaultTolerationDuration, &out.DefaultTolerationDuration
		*out = new(metav1.Duration)
		**out = **in
	}
}
