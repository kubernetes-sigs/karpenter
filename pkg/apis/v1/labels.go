...
const (
	...
	DoNotDisruptScheduleAnnotationKey          = apis.Group + "/do-not-disrupt-schedule"
	DoNotDisruptScheduleDurationAnnotationKey  = apis.Group + "/do-not-disrupt-schedule-duration"
