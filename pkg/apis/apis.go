...
//go:generate go tool -modfile=../../go.tools.mod controller-gen crd:allowDangerousTypes=true object:headerFile="../../hack/boilerplate.go.txt" paths="./..." output:crd:artifacts:config=crds
var (
