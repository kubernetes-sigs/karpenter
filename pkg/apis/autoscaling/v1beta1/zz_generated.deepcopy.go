...
func (in *CapacityBufferSpec) DeepCopyInto(out *CapacityBufferSpec) {
	*out = *in
	...
	if in.RefillStrategy != nil {
		in, out := &in.RefillStrategy, &out.RefillStrategy
		*out = new(string)
		**out = **in
	}
	if in.FillDeadlineSeconds != nil {
		in, out := &in.FillDeadlineSeconds, &out.FillDeadlineSeconds
		*out = new(int32)
		**out = **in
	}
}
...
func (in *CapacityBufferStatus) DeepCopyInto(out *CapacityBufferStatus) {
	*out = *in
	...
	if in.ConsumedReplicas != nil {
		in, out := &in.ConsumedReplicas, &out.ConsumedReplicas
		*out = new(int32)
		**out = **in
	}
