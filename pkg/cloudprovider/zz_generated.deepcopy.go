...
func (in *DynamicResources) DeepCopyInto(out *DynamicResources) {
	*out = *in
	if in.ResourceSliceTemplates != nil {
		in, out := &in.ResourceSliceTemplates, &out.ResourceSliceTemplates
	...
	if in.AttributeBindings != nil {
		...
		*out = make([]*AttributeBinding, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicResources.
